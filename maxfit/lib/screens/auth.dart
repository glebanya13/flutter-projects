...
class _AuthorizationPageState extends State<AuthorizationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void _loginButtonAction() async {
      ...
      Client? user = await _authService.signInWithEmailAndPassword(_email.trim(), _password.trim());
      if(user == null)
      {
    ...
    void _registerButtonAction() async {
      ...
      Client? user = await _authService.registerWithEmailAndPassword(_email.trim(), _password.trim());
      if(user == null)
      {
        Fluttertoast.showToast(
